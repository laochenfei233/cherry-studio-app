...
const CODE_REASONS: Readonly<Partial<Record<string, AiFailureReason>>> = {
 ...
 */
export function classifyAiFailureReason(facts: AiFailureFacts): AiFailureReason {
