...
import type { ModelPickerBadge as ModelPickerBadgeValue } from '../utils/modelPickerBadges';
...
export function ModelPickerBadge({
  badge,
  testIDPrefix = 'model-picker-badge',
}: {
  badge: ModelPickerBadgeValue;
  testIDPrefix?: string;
}) {
