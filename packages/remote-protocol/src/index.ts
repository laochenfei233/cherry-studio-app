...
export { remoteDiscoveryType, remoteConnectPath, directEndpointSchema, configuredEndpointsSchema, remoteDiscoveryTxtSchema, directEndpointUrl, parseDirectEndpoint } from './discovery'
