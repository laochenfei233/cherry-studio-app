...
// ==================== 主要用户接口 ====================
export { createAgent, type CreateAgentOptions } from './core/agents'
export { createExecutor, embedMany, generateImage, generateText, rerank, streamText } from './core/runtime'
